open(OUTFILE, ">OUTFILE_WITH_GENERATED_WIRES_v8.csv");
open(SCHEMA, ">SCHEMA_v8.txt");
...
open(INFILE, "OUTFILE_WITH_GENERATED_WIRES_v8.csv");
open(OUTFILE, ">GENERATED_WIRES_v8.csv");
